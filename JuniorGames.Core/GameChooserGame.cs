namespace JuniorGames.Games
{
    ...
    public class GameChooserGame : GameBase
    {
        ...
        public GameChooserGame(GameBootstrapper gameBootstrapper, IBox box, GameChooserOptions options) :
            base(box)
        {
            ...
            this.idleTimeout = this.Box.Options.IdleTimeout;

            this.resetSubscription = this.Box.Reset
                .Subscribe(next => this.FireReset());

            this.registeredGames = new Dictionary<ButtonIdentifier, Func<IGame>>
            {
                {BoxBase.GreenOneButtonIdentifier, () => this.gameBootstrapper.AfterBurner()},
                {BoxBase.YellowOneButtonIdentifier, () => this.gameBootstrapper.LightifyOnButtonPress()},
                {BoxBase.RedOneButtonIdentifier, () => this.gameBootstrapper.ChainGame(5)}
        ...
        private async Task Sleep()
        {
            ...
            this.wakeupOrIdleSubscription = this.Box.LedButtonPinPins
